...
# Preserve existing rule identities while migrating to the data-driven rule set.
moved {
...
moved {
  from = openstack_networking_secgroup_rule_v2.jaeger_collector
  to   = openstack_networking_secgroup_rule_v2.this["jaeger-collector"]
}

moved {
  from = openstack_networking_secgroup_rule_v2.jaeger_ui
  to   = openstack_networking_secgroup_rule_v2.this["jaeger-ui"]
}
